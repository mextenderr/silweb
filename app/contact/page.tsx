            ...
            <div className="relative h-full z-10">
                ...
                <div className="flex flex-col gap-20 sm:gap-36 sm:pt-[100px] pt-[80px] blur-none">
                    ...
                    <div className="mb-16 sm:mb-28 flex flex-col items-center gap-20 sm:gap-32">
                        ...
                        <FadeInView>
                            <p className="text-lg sm:text-2xl text-center w-10/12 sm:w-8/12 font-bold">
                                Natuurlijk kan je ons ook altijd even bellen,
                                een Whatsappje sturen of ons via de socials
                                bereiken! We nemen zo spoedig mogelijk contact
                                met je op en kijken ernaar uit om samen iets
                                magisch te ontwikkelen!
                            </p>
                        </FadeInView>
                        <FadeInView>
